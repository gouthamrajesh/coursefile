...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES["file"])) {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
            ...
            $filepath = "uploads/miclg/" . $filename; // Relative path of the uploaded file
...
<head>
    ...
    <title>Mission of the College</title>
</head>
<body>
