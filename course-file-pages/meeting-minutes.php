...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES["file"])) {
    $targetDirectory = "../../uploads/meeting-minutes/";
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
            ...
            $filepath = "uploads/meeting-minutes/" . $filename; // Relative path of the uploaded file
...
<body>
    ...
    <div class="fac_name">
        ...
        <br>
        <h4>Course Committee Meeting Minutes</h4>
    </div>
