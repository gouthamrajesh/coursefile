...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES["file"])) {
    $targetDirectory = "../../uploads/assign-ans-key/";
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
            ...
            $filepath = "uploads/assign-ans-key/" . $filename; // Relative path of the uploaded file
...
<head>
    ...
    <title>Assignment Questions with Answer Key</title>
    <style>
        button[type="submit"] {
            padding: 10px 20px;
            margin-left: 30px;
...
<body>
    ...
    <div class="fac_name">
        ...
        <br>
        <h4>Assignment Questions with Answer Key</h4>
    </div>
