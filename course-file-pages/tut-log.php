...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES["file"])) {
    $targetDirectory = "../../uploads/tut-log/";
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
            ...
            $filepath = "uploads/tut-log/" . $filename; // Relative path of the uploaded file
